...
import com.hongdian.sys.auth.entity.SysLog;
import com.hongdian.sys.auth.entity.SysUser;
import com.hongdian.sys.auth.service.ISysLogService;
...
public class LogAspect {
    ...
    @AfterReturning(value = "@annotation(com.hongdian.sys.auth.annotation.Log)")
    ...
    @Before(value = "@annotation(com.hongdian.sys.auth.annotation.Log)")
