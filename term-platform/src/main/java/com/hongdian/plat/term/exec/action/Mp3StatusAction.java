...
import com.hongdian.plat.term.mqttmodel.up.Mp3StatusMqttEntity;
 ...
 */
@Component
public class Mp3StatusAction extends BaseAction{

	@Override
	public void excute(FepUpMqttEntity fep) {
		String content = fep.getContent();
		Mp3StatusMqttEntity entity = (Mp3StatusMqttEntity) JSONUtils.readValue(content, Mp3StatusMqttEntity.class);
	}
